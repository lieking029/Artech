...
@section('content')
    <div class="col-md-6">
        <div class="card mb-4 mx-4 bg-transparent rounded-5 text-white"
            style="backdrop-filter: blur(30px); background-color: rgba(255, 255, 255, 0.1);">
                ...
                <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3"><span class="input-group-text">
                            ...
                            <input class="form-control" type="text" name="facebook" placeholder="{{ __('Facebokk') }}"
                    ...
                    @if ($errors->any())
                        ...
                        @endforeach
                    @endif
                    <a href="/" class="btn btn-secondary px-4">Login</a>
                    <button class="btn btn-block btn-dark text-white" type="submit">{{ __('Submit') }}</button>
                </form>
            </div>
        </div>
    </div>
